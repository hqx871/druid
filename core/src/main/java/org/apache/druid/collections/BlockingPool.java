...
public interface BlockingPool<T>
{
   ...
   * @return a list of resource holders. An empty list is returned if {@code elementNum} resources aren't available.
   */
  List<ReferenceCountingResourceHolder<T>> takeBatch(String group, int elementNum, long timeoutMs);
   ...
   * @return a list of resource holders. An empty list is returned if {@code elementNum} resources aren't available.
   */
  List<ReferenceCountingResourceHolder<T>> takeBatch(String group, int elementNum);
}
