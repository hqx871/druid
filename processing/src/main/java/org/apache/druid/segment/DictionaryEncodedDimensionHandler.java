...
public abstract class DictionaryEncodedDimensionHandler<ValType extends Comparable<ValType>>
    implements DimensionHandler<Integer, int[], ValType>
{
  /**
  ...
  public DictionaryEncodedDimensionHandler(
  ...
  @Override
  public final DimensionSchema getDimensionSchema(ColumnCapabilities capabilities)
  {
    return new StringDimensionSchema(dimensionName);
  }

  @Override
  public final MultiValueHandling getMultivalueHandling()
  {
    return multiValueHandling;
  }

  @Override
  public final int getLengthOfEncodedKeyComponent(int[] dimVals)
  {
    return dimVals.length;
  }

  @Override
  public final Comparator<ColumnValueSelector> getEncodedValueSelectorComparator()
  {
    return DIMENSION_SELECTOR_COMPARATOR;
  }

  @Override
  public final SettableColumnValueSelector makeNewSettableEncodedValueSelector()
  {
