...
public class StringDimensionHandler extends DictionaryEncodedDimensionHandler<String>
{
  ...
  {
    super(dimensionName, multiValueHandling, hasBitmapIndexes, hasSpatialIndexes);
  }
