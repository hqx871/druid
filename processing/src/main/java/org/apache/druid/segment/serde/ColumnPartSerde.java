...
@JsonSubTypes(value = {
    ...
    @JsonSubTypes.Type(name = "stringDictionary", value = StringDictionaryEncodedColumnPartSerde.class),
    @JsonSubTypes.Type(name = "longDictionary", value = LongDictionaryEncodedColumnPartSerde.class),
