 ...
 * {@link GenericIndexed}.
 */
public abstract class DictionaryBitmapIndexColumnPartSupplier<ValType extends Comparable<ValType>>
    implements Supplier<BitmapIndex>
{
  ...
  public DictionaryBitmapIndexColumnPartSupplier(
  ...
  public BitmapIndex get()
  {
    return new BitmapIndex()
    {
      ...
      {
        ValType val = dictionary.get(index);
      ...
      public int getIndex(@Nullable String value)
      {
        ...
        return dictionary.indexOf(parseStringValue(value));
      }
